...
import { propsTabAtom } from "./3-window-detail/atoms";
import { loadWindowDetailInfo, windowDetailStore } from "./3-window-detail/store";
import { type PropsTab, type WindowDetailInfo } from "./3-window-detail/types";
