...
export function IconControlTreeChild({ className, title, ...rest }: HTMLAttributes<SVGSVGElement>) {
    return (
        <svg className={classNames("fill-none stroke-current", className)} viewBox="0 0 24 24" {...rest}>
            ...
            <rect className="stroke-current/50" x="4.12" y="1.88" width="5.25" height="5.25" rx="1.11" ry="1.11" /> {/* root */}
        </svg>
    );
}
