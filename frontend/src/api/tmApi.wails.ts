...
export function createWailsTmApi(): WinWatchApi {
    return {
        ...
        getControlAccInteract: (handle, runtimeId) => GetControlAccInteract(handle, runtimeId),
        executeAccAction: (handle, runtimeId, kind, actionId, value) => ExecuteAccAction(handle, runtimeId, kind, actionId, value),
